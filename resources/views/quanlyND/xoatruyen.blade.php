        ...
        <div class="col-md-8">
          ...
          <div class="row search-view-element">
            ...
            <div class="col-md-7">
              ...
              <p><i class="fas fa-star"></i> <?php echo $temp->diemDG. "/10"; ?></p>
              <p>Chap: 31</p>
              <div class="author">
          ...
          <a href="{{route('da_xoatruyen',['id'=>$temp->maTruyen])}}" type="button" name="button" style="margin: 10px auto;width: 40%;background: #00b2bf;padding: 10px;border: none;font-weight: bold;color: #fff;font-size: 18px;">Đồng ý</a>
